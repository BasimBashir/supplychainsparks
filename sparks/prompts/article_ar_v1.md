...
Write in native, professional journalistic Arabic (not a literal translation).
Keep company names and port names in their standard Arabic business usage;
numbers in Western Arabic numerals.
...
Produce exactly these JSON fields (values in Arabic, keys unchanged):
